...
There are multiple genres of movies, with varying dates of origin. To determine variables we will comb through the data and find the mean of the budget for a movie and the ratings.   
...
```
  ...
  Using this chart we can determine the average rating of all the movies in a chunk of 58788 observations. The average is 5.93285.  
  
```{r}
median(movies$rating)
```  
  Using this chart we can determine the median of all the movies in a chunk of 58788 observations. The average is 6.1.
  To determine the average movie budget we utilized the same formatted r block.
...
```  
 ...
 Using this chart we can see that the average movie budget is 3000000.
...
- What is the average movie rating? The average movie rating is 5.9

- What is the median budget for a movie? The median budget is 30000000.
...
According to the above chart, 58,788 movies were released in 1995.
...
10 comedy movies displayed in this chart have an MPAA over 8, while being over 120 minutes long.
...
According to this chart there are 8 Harry Potter movies with the highest rated movie, Deathly Hallows Part 2, having the most votes on imdb.com.
...
According to this chart there are 58,788 action movies that qualify with over 100 votes. 
...
No, my favorite movie is not in this list of movies.
